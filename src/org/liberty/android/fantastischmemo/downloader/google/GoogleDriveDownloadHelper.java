...
public class GoogleDriveDownloadHelper {
    ...
    public void downloadSpreadsheetToDB(Spreadsheet spreadsheet) throws Exception {
        String worksheetAddress = "https://spreadsheets.google.com/feeds/worksheets/" + spreadsheet.getId() + "/private/full";
        ...
        for (Worksheet w : worksheets) {
            ...
            URL url1 = new URL("https://spreadsheets.google.com/feeds/cells/" + spreadsheet.getId() + "/" + w.getId() + "/private/full");
