...
public class GoogleAccountScreen extends Activity {
    ...
    private void authenticatedClientLogin(String authToken) {
        ...
        String apiKey = "AIzaSyBgSh_sLf2FUvKgc6ZjoYXLvf6viYWFZSo";

        try {
            URL url = new URL("https://docs.google.com/feeds/default/private/full?v=3");
            URLConnection conn = (HttpURLConnection) url.openConnection();
            conn.addRequestProperty("client_id", "45533559525.apps.googleusercontent.com");
            conn.addRequestProperty("client_secret", "74rz27lrTr9mWNnipgxXwtEd");
