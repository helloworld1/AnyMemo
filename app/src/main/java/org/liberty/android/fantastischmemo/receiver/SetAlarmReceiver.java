...
public class SetAlarmReceiver extends BroadcastReceiver{
    ...
    public static void setNotificationAlarm(Context context){
        ...
        PendingIntent sender = PendingIntent.getBroadcast(context, ALARM_REQUEST_CODE, myIntent, getPendingIntentFlags(PendingIntent.FLAG_CANCEL_CURRENT));
    ...
    public static void setWidgetUpdateAlarm(Context context){
        ...
        PendingIntent sender = PendingIntent.getBroadcast(context, ALARM_REQUEST_CODE + 1, myIntent, getPendingIntentFlags(PendingIntent.FLAG_CANCEL_CURRENT));
