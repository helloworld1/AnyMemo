...
public class CardProviderTest extends AbstractExistingDBTest {
    ...
    public void testNonExistingDbShouldReturnNullCursor() {
        ...
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + "No_such_db_exists.db"+ "/count"),null, null, null, null);
        assertNull(cursor);
    }
    ...
    public void testCardCount() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/count"),null, null, null, null);
    ...
    public void testGetRandomCards() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/random/10"),null, null, null, null);
    ...
    public void testGetByOrdinal() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/ordinal/3"),null, null, null, null);
        assertEquals(1, cursor.getCount());
        assertTrue(cursor.moveToFirst());
    ...
    public void testGetById() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/id/3"),null, null, null, null);
        assertEquals(1, cursor.getCount());
        assertTrue(cursor.moveToFirst());
        assertEquals(3, cursor.getInt(cursor.getColumnIndex("ordinal")));
        assertEquals("face", cursor.getString(cursor.getColumnIndex("question")));
    ...
    public void testGetCardWithStartOrdinalAndCount() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/start_ordinal/3/count/5"),null, null, null, null);
    ...
    public void testGetAllCards() {
        ContentResolver cr = getContext().getContentResolver();
        Cursor cursor = cr.query(Uri.parse("content://" + AUTHROITY + "/" + TestHelper.SAMPLE_DB_NAME + "/all"),null, null, null, null);
